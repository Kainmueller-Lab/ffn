...
coord_file=$root/coordinates_lom_32/coords
...
bsub -n 5 -gpu "num=1" -q gpu_rtx -W 144:00 -o $log_file python train.py --train_coords $coord_file --data_volumes $raw_files --label_volumes $label_files --model_name convstack_3d.ConvStack3DFFNModel --model_args "{\"depth\": 12, \"fov_size\": [33, 33, 33], \"deltas\": [8, 8, 8]}" --train_dir $exp_dir --max_steps $max_steps --fov_policy max_pred_moves
